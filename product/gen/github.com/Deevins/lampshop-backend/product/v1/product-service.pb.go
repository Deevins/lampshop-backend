...
// 	protoc        v5.29.3
// source: product/v1/product-service.proto
...
var file_product_v1_product_service_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x63, 0x74, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0a, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x76, 0x31, 0x22, 0x15,
	...
	0x6f, 0x6d, 0x2f, 0x44, 0x65, 0x65, 0x76, 0x69, 0x6e, 0x73, 0x2f, 0x6c, 0x61, 0x6d, 0x70, 0x73,
	0x68, 0x6f, 0x70, 0x2d, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x64,
...
var file_product_v1_product_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_product_v1_product_service_proto_depIdxs = []int32{
	2, // 0: product.v1.ListProductsResponse.products:type_name -> product.v1.Product
	0, // 1: product.v1.ProductService.ListProducts:input_type -> product.v1.ListProductsRequest
	1, // 2: product.v1.ProductService.ListProducts:output_type -> product.v1.ListProductsResponse
...
func file_product_v1_product_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_product_v1_product_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_product_v1_product_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_product_v1_product_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
